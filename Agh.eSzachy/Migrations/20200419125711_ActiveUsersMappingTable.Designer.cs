...
namespace Agh.eSzachy.Migrations
{
    ...
    [Migration("20200419125711_ActiveUsersMappingTable")]
    partial class ActiveUsersMappingTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Agh.GameEntity", b =>
                {
            ...
            modelBuilder.Entity("Agh.MessageEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(95) CHARACTER SET utf8mb4");
            ...
            modelBuilder.Entity("Agh.RoomEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(95) CHARACTER SET utf8mb4");
            ...
            modelBuilder.Entity("Agh.RoomEntity", b =>
                {
                    b.HasOne("Agh.GameEntity", "ActualGame")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Agh.eSzachy.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
